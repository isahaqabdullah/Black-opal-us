...
const siteIds = ['black-opal-us'];

const homePageDocuments: SanityDocument[] = siteIds.map((siteId) => ({
  _id: `homePage-${siteId}`,
  _type: 'homePage',
...
const siteSettingsDocuments: SanityDocument[] = siteIds.map((siteId) => ({
...
const aboutPageDocuments: SanityDocument[] = siteIds.map((siteId) => ({
