...
const SITE_IDS = ['black-opal-us'];
const SITE_SPECIFIC_BASE_IDS = ['siteSettings', 'aboutPage'];
const SHARED_DOCUMENT_IDS = ['pageCopy'];
const EXISTING_DOCUMENT_IDS = ['homePage', 'homePage-black-opal-us', 'productionPage'];
...
async function main() {
  ...
  const defaultHomePage = seedById.get('homePage-black-opal-us');
  const results = [];
